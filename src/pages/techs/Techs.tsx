...
const languages: Language[] = [
  {
    ...
    imgSrc: htmlSvg,
    description:
      'É uma linguagem de marcação utilizada para construir páginas web. Faz parte do que uso no dia a dia.',
  },
  {
    name: 'CSS',
    imgSrc: cssSvg,
    description:
      'Uso esta linguagem de estilo para deixar as páginas mais atraentes ao usuário.',
  },
  {
    name: 'JavaScript',
    imgSrc: javaScriptSvg,
    description:
      'Essa linguagem de script seria responsável pelos comportamentos da página e o que mais os usuários utilizam como abrir um menu, fechar...',
  },
  {
    name: 'TypeScript',
    imgSrc: typeScriptSvg,
    description:
      'Utilizo mais internamente para facilitar meu desenvolvimento.',
  },
  {
    name: 'React.js',
    imgSrc: reactSvg,
    description:
      'Traz poder ao meu desenvolvimento pois consigo utilizar javascript dentro do html.',
  },
  {
    name: 'Node.js',
    imgSrc: nodeJsSvg,
  ...
  },
  {
    ...
    description:
      'Uma biblioteca/framework poderosissimos, facilitou bastante a construção deste portfólio.',
  },
  {
    name: 'Jest',
    imgSrc: jestPng,
  ...
  },
  {
    ...
    imgSrc: figmaSvg,
    description:
      'Bastante usado para criar protótipos antes do desenvolvimento propriamente dito.',
  },
];
...
const languagesHuman: Language[] = [
  ...
  },
  {
    name: 'Russo',
    description:
      'Comecei a estudar recentemente por conta própria e sei apenas o básico.',
    imgSrc: russiaPng,
  },
];

const languagesIKnew = [
  'Java',
  'Python',
  'Django',
  'Scss',
  ...
  return (
    <>
      <section className="container p-10 md:pt-32">
        <h2 className="uppercase tracking-widest mb-5">
          Minhas techs do dia a dia
        </h2>
        <ul className="grid md:grid-cols-2 gap-5">
          {languages.map((language, index) => {
            return (
              <li
                key={index}
                className="bg-violet-300 p-5 shadow-lg rounded-sm dark:text-neutral-700"
              >
        ...
        <h2 className="uppercase tracking-widest mt-20 mb-2">
          Tecnologias que conheço e já utilizei.
        </h2>
        <ul
          role="list"
          className="marker:text-violet-500 list-disc pl-5 space-y-3 text-slate-500 mb-5"
        >
